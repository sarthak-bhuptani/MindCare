        ...
        <div className="min-h-screen flex flex-col bg-[#fdfdfd] dark:bg-[#0a0a0a] overflow-hidden">
            ...
            <main className="flex-grow flex items-center justify-center pt-32 pb-24 px-4 relative z-10">
                ...
                >
                    ...
                    <div className="hidden lg:flex flex-col items-center justify-center p-12 bg-primary/5 rounded-[3rem] border border-primary/10 backdrop-blur-sm relative overflow-hidden group">
                        ...
                        >
                            <h2 className="text-2xl font-bold text-primary mb-2">Eyes on the goal!</h2>
                            <p className="text-muted-foreground">The avatar will follow your moves. <br /> Focusing on your password makes them shy.</p>
                        </motion.div>
                    </div>
                            ...
                            <form onSubmit={handleLogin} className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    <div className="flex items-center justify-between ml-1">
                                        ...
                                        <Link to="/forgot-password" className="text-sm text-primary font-semibold hover:underline underline-offset-4">
                                            Forgot password?
                                        </Link>
                                    </div>
                                    <div className="relative group">
